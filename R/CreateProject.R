                           ...
                           bCreateShinyAppAsPackage   = TRUE)
{
    ...
    strRet                      <-
        CopyFiles(strTemplateDirectory, strNewProjectDirectory, FALSE)
    ...
    if (bCreateCalculationPackage)
    {
        ...
        strCalcPkgRet               <-
            CreateBaSSRPackage(
                strProjectDirectory      = strNewProjectDirectory,
    ...
    strAppInstructions <-
        "In the project dierectory, please view the ProjectInstructions.html or ProjectInstructions.Rmd "
    strRet <-
        paste(
            c(
                "Creating BaSS App...",
