...
poor_mans_flatly2 <- function(  )
{
    ddlItem <- c( "Poor man's Flatly 2" = "poor_mans_flatly2" )
    theme <- shinyDashboardThemeDIY(
            ...
            ### header
            ,logoBackColor = "rgb(0,125,255)" #"rgb(24,188,156)"
            
            ,headerButtonBackColor = "rgb(0,125,255)" #"rgb(24,188,156)"
            ,headerButtonIconColor = "rgb(44,62,80)"
            ,headerButtonBackColorHover = "rgb(20,154,128)"
            ,headerButtonIconColorHover = "rgb(0,0,0)"
            
            ,headerBackColor = "rgb(0,125,255)" #"rgb(24,188,156)"
            ...
            ,sidebarTabTextColorSelected = "rgb(0,125,255)" #"rgb(24,188,156)"
            ,sidebarTabRadiusSelected = "0px"
            
            ,sidebarTabBackColorHover = "rgb(44,62,80)"
            ,sidebarTabTextColorHover = "rgb(0,125,255)" #"rgb(24,188,156)"
