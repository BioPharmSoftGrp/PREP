...
This Shiny app is based on modules.  Modules allow the app UI and Server elements to be broken into seperate files, thereby, making it easier to test and develop in a team environment.  

The intent is to provide a starting point for Shiny apps that are likely to be larger applicaitons.    
