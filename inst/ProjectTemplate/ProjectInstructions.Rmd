...
Each project, Shiny app and computational package,  wehre created as subdirectories of this folder.  Each folder consists of an R Studio project file with the extension .Rproj.  For each project, please open these files. Within each project there is a Instructions.Rmd file to provide specific details about that project. 
...
# For the Shiny App
AddNewTabToApp( strTabName, vSubMenuItemNames ) - This funciton will add a new tab to the Shiny App. This function assumes that the working directory
...
AddFunctionToPkg( strFunctionName, strPkgDir = "", strFunctionDescription = "" ) - Add a new function named strFunctionName to a package.  This function creates a file names R/strFunctionName.R
